...
<div class="section-hero">
    ...
    <!--<video id="video-promo" autoplay="" preload="auto" playsinline="" webkit-playsinline="" muted="" controls=""
           poster="<?php print $template_path;?>/img/video-screen.jpg"
           data-mobile="<?php print $template_path?>/resources/cap3-mobile"
           data-desktop="<?php print $template_path?>/resources/cap3-desktop">
        <source id="source-mp4" type="video/mp4">
        <source id="source-webm" type="video/webm">
        No video
    </video>-->
    <a href="/user/register">
        <img class="d-none d-md-block" src="<?php print $template_path?>/img/Banner_Destapa_Desktop_v2_2.png">
        <img class="d-md-none" src="<?php print $template_path?>/img/Banner_Destapa_Mobile_v2_2.png">
    </a>
    
  <div class="content-wrapper" onclick="Drupal.aguilaDestapa.toggleVideo()" style="cursor:pointer">
...
<!--          <li><a href="#premios">Premios</a></li>-->
      ...
      <!--<div class="copy-wrapper">
        <div class="row">
          <div class="col-12">
            <!--<h1>ESTO ES DESTAPA EL CAMERINO</h1>
            <h3>Entra, conoce los secretos de nuestra sele y gana por verlos y compartirlos. </h3>-->
            <?php if (user_is_anonymous()):?>
                <!--<a href="/user/register" class="btn btn-default">Regístrate para empezar</a>-->
            <?php endif;?>
          </div>
        </div>
      </div>-->
        ...
        <div class="row d-none d-md-block">
          <div class="col-8 offset-2 text-center d-none d-md-block">
            <div class="row">
              ...
              <div class="col-4  text-center">
                <figure><img src="<?php print $template_path;?>/img/como-ganar-2.1.png"/></figure>
                <span>Compartir los contenidos</span>
              </div>

              <div class="col-4  text-center">
                <figure><img src="<?php print $template_path;?>/img/como-ganar-3.1.png"/></figure>
                <span>Contesta las preguntas</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="slider-premios" class="row d-md-none">
          <div class="col-12">
            <ul>
              ...
              <li>
                <figure><img src="<?php print $template_path;?>/img/como-ganar-2.1.png"/></figure>
                <span>Compartir los gifs y contenidos</span>
              </li>
              <li>
                <figure><img src="<?php print $template_path;?>/img/como-ganar-3.1.png"/></figure>
                <span>Contesta las preguntas</span>
      ...
      <div class="premios-wrapper">
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-auto text-center">
            <figure><img src="<?php print $template_path;?>/img/temp-award.png"/></figure>
            <h6>Premio 1</h6>
            <p>Ranking 1 al 50</p>
          </div>
...
<div class="section-terminos">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <a class="btn btn-secondary" href="<?php print $template_path?>/resources/TERMINOS-Y-CONDICIONES-DESTAPA-EL-CAMERINO.pdf?t=b" target="_blank">Términos y condiciones</a>
      </div>
    </div>
  </div>
