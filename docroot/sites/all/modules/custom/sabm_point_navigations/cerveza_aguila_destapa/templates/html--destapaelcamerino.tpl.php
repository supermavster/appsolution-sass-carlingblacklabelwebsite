...
<head>
  ...
  <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    })(window,document,'script','dataLayer','GTM-TMQJFH');</script>
  ...
  <script type="text/javascript">
    ...
    smartlook('init', 'ee0bb6733332f73c36349e41c6e8c8afff5d3981');
  </script>
...
<?php 
  ...
  ?>
    <script type="text/javascript">
          dataLayer.push({'event': 'navigation', 'eventCategory' : 'user', 'eventAction': 'status', 'eventLabel': '<?php echo $us->mail; ?>'});
    </script>
  <?php } ?>
